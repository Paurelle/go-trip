...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211012_gotrip_fef576ac8628ace73552_20211012145452_archive.zip';
	const ARCHIVE_SIZE		 = '45689242';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'fef576a-12145452';
    const SECONDARY_PACKAGE_HASH = 'fbffa8a-12145452';
	const VERSION			 = '1.4.3';
